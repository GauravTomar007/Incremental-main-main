...
class ModelTuning:
    ...
    # function check the distribution of target class
    ...
    def tune_random_forest(self,X_train,y_train):
        ...
        grid_search = GridSearchCV(
            ...
            cv=3,
            scoring="f1_weighted",#precison, recall, class imbalance
            n_jobs=-1
        )
    ...
    # Save Best Model
    def save_best_model(self,model, file_name="reports/best_model.pkl"):
